...
import giocorogue.interfaccia.GamePanel;
    ...
    public void loadMap(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            if (row < gp.maxWorldRow) {
                System.out.println("Attenzione: la mappa ha " + row + " righe, ma servono " + gp.maxWorldRow + ".");
            }

        } catch (FileNotFoundException e) {
            System.out.println("Mappa non trovata: res/maps/world01.txt");
            e.printStackTrace();
        } catch (IOException e) {
